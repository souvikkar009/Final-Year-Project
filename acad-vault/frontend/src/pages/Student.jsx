...
const Student = () => {
    ...
    return (
        <div className="my-12 w-9/10 mx-auto shadow-lg border border-slate-400 shadow-slate-400 p-8 rounded-lg bg-gradient-to-br from-slate-900 via-slate-900 to-slate-900 text-white">
            ...
            {student && (
                <div>
                    ...
                    {student.secondary?.institute_id && (
                    ...
                    {student.higher_secondary?.institute_id && (
